...
_C.MODEL.UNET.N_CHANNELS = [32, 64, 128, 256, 512]
_C.MODEL.UNET.N_BLKS = [2, 2, 2, 2, 2]
_C.MODEL.UNET.ATTN = [False, False, False, True, True]
_C.MODEL.UNET.N_GROUPS = 32
_C.MODEL.UNET.EPS = 1e-6
_C.MODEL.UNET.N_HEADS = 8
_C.MODEL.UNET.T_EMB_DIM = _C.MODEL.UNET.N_CHANNELS[0] * 4
